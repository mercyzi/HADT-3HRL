...
parser.add_argument("--simulate_epoch_number", dest="simulate_epoch_number", type=int, default=10000, help="The number of simulate epoch.")
...
parser.add_argument("--evaluate_session_number", dest="evaluate_session_number", type=int, default=104, help="the size of each simulate epoch when evaluation.")
...
parser.add_argument("--machine_trained", dest="machine_trained", type=boolean_string, default=True, help="Lower machine trained? [True, False]")
parser.add_argument("--saved_machine_trained", dest="saved_machine_trained", type=str, default="/home/zxh/src/model/DQN/checkpoint/0526171200_agenthrljoint2_T20_ss100_lr0.0005_cp20_Gall_beta-0.0_smt5_RFS60_RFF0_RFNCY0.0_RFIRS0_RFRA-44_RFRMT-66_mls0_gamma0.95_gammaW0.1_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_wfrs44.0_dtft0_ird0_ubc0.985_lbc1e-10_dataMuzhi_Dataset_RID0/model_d10agenthrljoint2_s0.19_r11.408_t12.176_mr0.179_mr2-0.861_e-249.pkl")
parser.add_argument('--data_type', dest='data_type', type=str, default='real', help='the data type is either simulated or real')
parser.add_argument("--doctor_acc", dest="doctor_acc", type=float, default=0.7, help="human acc")
parser.add_argument('--subtask_max_turn', dest='subtask_max_turn', type=int, default=3, help='subtask_max_turn')
parser.add_argument("--classifier_training",dest="classifier_training", type=boolean_string, default=False, help="classifier_training? [True, False]")
parser.add_argument("--saved_master_trained", dest="saved_master_trained", type=str, default="/home/zxh/HRL/src/model/DQN/checkpoint/0502155155_agenthrljoint2_DA0.7_RFH-1.3199999999999998_ST3_T20_ss100_lr0.0005_RFS66_RFF0_RFNCY0.0_RFIRS0_RFRA-44_RFRMT-44_mls0_gamma1_gammaW0.9_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_wfrs44.0_dtft0_ird0_ubc0.985_lbc1e-10_dataMuzhi_Dataset_RID0/s0.257_r16.94_t16.497_aah0.47_mr2-0.988_e-61.pkl")
...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="/home/zxh/HRL_ppo/src/model/DQN/checkpoint/0530113017_agenthrljoint2_DA0.7_RFH-5_ST3_T20_ss200_lr0.0005_wfrs5.0_RFS20_RFF0_RFNCY0.0_RFIRS0_RFRA-44_RFRMT-44_mls0_gamma1_gammaW0.9_epsilon0.1_awd0_crs0_hwg0_wc0_var0_sdai0_dtft0_ird0_ubc0.985_lbc1e-10_dataMuzhi_Dataset_RID0/s0.796_r15.915_t13.415_aah0.239_mr2-0.808_e-1445.pkl")
...
# reward design
parser.add_argument("--reward_for_activate_doctor", dest="reward_for_activate_doctor", type=float,default=-5)# 0.45-0.50
...
parser.add_argument("--reward_for_reach_max_turn", dest="reward_for_reach_max_turn", type=float, default=-44)
...
parser.add_argument("--weight_for_reward_shaping", dest='weight_for_reward_shaping', type=float, default=5.0, help="weight for reward shaping. 0 means no reward shaping.")
