...
def construct_info(params):
    ...
    doctor_acc = params.get("doctor_acc")
    reward_for_activate_doctor = params.get("reward_for_activate_doctor")
    ...
    subtask_max_turn = params.get("subtask_max_turn")
    ...
    info = run_time + \
           "_" + agent_id + \
           "_DA" + str(doctor_acc) + \
           "_RFH" + str(reward_for_activate_doctor) + \
           "_ST" + str(subtask_max_turn) + \
           "_T" + str(max_turn) + \
